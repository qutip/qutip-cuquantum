...
copyright = '2025, QuTiP developers and contributors'
...
release = qutip_cuquantum_version()
...
html_title = 'QuTiP-cuQuantum {} Documentation'.format(version)

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'QuTiP-cuQuantum'
